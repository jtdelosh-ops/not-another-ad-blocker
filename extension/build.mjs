...
await build({ entryPoints: { background: 'src/background/index.ts', content: 'src/content/index.ts', popup: 'src/popup/index.ts', options: 'src/options/index.ts' }, outdir: 'dist', bundle: true, target: 'chrome121', format: 'iife', sourcemap: true });
